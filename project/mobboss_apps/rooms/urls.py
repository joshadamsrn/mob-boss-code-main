...
urlpatterns = [
    ...
    path("<str:room_id>/replace-catalog", views.replace_catalog, name="rooms-replace-catalog"),
    path("<str:room_id>/presets/save", views.save_catalog_as_preset, name="rooms-presets-save"),
    path("<str:room_id>/presets/<int:preset_id>/rename", views.rename_preset, name="rooms-presets-rename"),
    path("<str:room_id>/presets/<int:preset_id>/delete", views.delete_preset, name="rooms-presets-delete"),
    path("<str:room_id>/presets/<int:preset_id>/overwrite", views.overwrite_preset, name="rooms-presets-overwrite"),
    path("<str:room_id>/deactivate-item/<str:classification>", views.deactivate_item, name="rooms-deactivate-item"),
    path("<str:room_id>/set-mob-secret-word", views.set_mob_secret_word, name="rooms-set-mob-secret-word"),
